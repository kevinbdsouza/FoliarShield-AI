...
class SchemaValidationTests(unittest.TestCase):
    def test_valid_minimal_records_pass(self) -> None:
        records = [
            ...
            PayloadCombination(
                id="payload_combination:azospirillum-bacillus-001",
                source="unit-test",
                license="CC-BY-4.0",
                provenance="tests/test_schemas.py",
                confidence=0.6,
                payload_ids=("strain:azospirillum-001", "strain:bacillus-001"),
            ...
            CandidateDesign(
                ...
                confidence=0.6,
                payload_ids=("strain:azospirillum-001", "strain:bacillus-001"),
                payload_combination_id="payload_combination:azospirillum-bacillus-001",
                payload_ratios={"strain:azospirillum-001": 0.5, "strain:bacillus-001": 0.5},
                crop="millet",
            ...
            BenchmarkResult(
                ...
                provenance="tests/test_schemas.py",
                confidence=1.0,
                task_id="pilot-1-millet-drought-payload_combination",
